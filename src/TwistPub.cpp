...
int main(int argc, char **argv)
{
  ...
  //ros::Publisher vel_pub_0 = n.advertise<geometry_msgs::Twist>("/left_wheel_hinge/cmd_vel", 1);
  //ros::Publisher vel_pub_1 = n.advertise<geometry_msgs::Twist>("/right_wheel_hinge/cmd_vel", 1);
